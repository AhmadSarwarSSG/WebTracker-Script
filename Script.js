    ...
    if (websiteId === "" || websiteId === null || websiteId === undefined) {
        ...
        $.ajax({
            ...
            success: function (location) {
                ...
                connection.invoke("AddNewUser", getWebsite(), getUrl(), getDeviceType(), f.browser, JSON.stringify(location), f.os);
            }
        });
    }
...
document.addEventListener('click', (event) => {
    ...
    if (action != "") {
        ...
        connection.invoke("ReceiveAction", getUrl(), action, data, flowId);
    }
});
